  ...
  return (
    <div className="relative flex min-h-screen bg-background">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="animate-morph animate-pulse-glow absolute -top-32 -right-32 h-[500px] w-[500px] bg-primary/8 blur-[100px]" />
        <div className="animate-morph absolute bottom-0 -left-20 h-[400px] w-[400px] bg-accent/6 blur-[80px]" style={{ animationDelay: "-4s" }} />
      </div>
      ...
      {/* Left branding panel */}
      <div className="relative hidden flex-1 flex-col justify-between overflow-hidden border-r border-border bg-card/30 p-12 lg:flex">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Founder, Loomify</p>
            </div>
          </div>
        </div>
        ...
        <div className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="animate-spin-slow h-[400px] w-[400px] rounded-full border border-primary/[0.06]" />
          <div className="animate-spin-slow absolute inset-8 rounded-full border border-accent/[0.04]" style={{ animationDirection: "reverse" }} />
        </div>
      </div>
